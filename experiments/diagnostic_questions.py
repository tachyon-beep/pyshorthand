...
DIAGNOSTIC_QUESTIONS = [
    ...
    DiagnosticQuestion(
        ...
        expected_tools=["get_class_details(GPT)", "get_class_details(Block)", "get_implementation(GPT.forward)"],
        crosses_files=3,
    ...
    DiagnosticQuestion(
        ...
        expected_tools=["get_class_details(GPT)", "get_class_details(GPTConfig)", "get_implementation(GPT.forward)"],
        crosses_files=2,
        needs_implementation=True,
    ),
    ...
    DiagnosticQuestion(
        ...
        expected_tools=["get_class_details(CausalSelfAttention)", "get_class_details(Block)", "get_class_details(GPT)", "search_usage(CausalSelfAttention)"],
        crosses_files=3,
        needs_implementation=False,
    ),
    ...
    DiagnosticQuestion(
        ...
        expected_tools=["get_class_details(GPTConfig)", "get_class_details(CausalSelfAttention)", "get_implementation(CausalSelfAttention.__init__)"],
        crosses_files=2,
        needs_implementation=True,
    ),
    ...
    DiagnosticQuestion(
        ...
        expected_tools=["get_class_details(GPT)", "get_class_details(Block)", "get_class_details(CausalSelfAttention)", "get_class_details(MLP)"],
        crosses_files=4,
        needs_implementation=False,
    ),
]
